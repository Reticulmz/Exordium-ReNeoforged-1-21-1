...
public class GuiHealthMixin implements HealthAccess {
    ...
    @WrapOperation(method = "maybeRenderPlayerHealth", at = {
    ...
    @WrapOperation(method = "maybeRenderVehicleHealth", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/Gui;renderVehicleHealth(Lnet/minecraft/client/gui/GuiGraphics;)V"))
